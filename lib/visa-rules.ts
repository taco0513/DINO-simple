...
export const visaRules: Record<string, VisaRule> = {
  ...
  TH: { maxDays: 60, ruleType: 'reset', resetInfo: 'Resets upon exit. Land border: max 2 entries/year. Air: unlimited but may be questioned. ETA required from June 2025 (free).' }, // Updated July 2024: 60 days visa-free, ETA from June 2025
  VN: { maxDays: 90, ruleType: 'reset', resetInfo: 'E-visa required ($25). Multiple entry available. Cannot extend beyond 90 days.' }, // E-visa updated Aug 2023: 90 days, multiple entry
  SG: { maxDays: 90, ruleType: 'reset', resetInfo: 'Resets upon exit. Frequent visa runs may be questioned.' },
  MY: { maxDays: 90, ruleType: 'reset', resetInfo: 'Resets upon exit. Multiple entries allowed. Must complete MDAC within 3 days before arrival (free).' },
  ...
  AT: { maxDays: 90, periodDays: 180, ruleType: 'rolling', resetInfo: 'Schengen Area: 90 days in any 180-day period. ETIAS (€20) required from Q4 2026.' },
  ...
  // Non-Schengen Europe
  GB: { maxDays: 180, periodDays: 365, ruleType: 'rolling', resetInfo: '180 days in any 365-day period' },
