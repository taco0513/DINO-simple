          ...
          <div className="mt-4 p-3 bg-blue-50 border border-blue-200 rounded-lg">
            <div className="flex items-start gap-2">
              ...
              <p className="text-sm text-blue-800">
                <strong>Note:</strong> Some government websites may block direct access (403 error) due to security policies. 
                If a link doesn't work, use the copy button 📋 to paste the URL directly into your browser.
              </p>
            </div>
          </div>
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">
                      <div className="flex items-center gap-2">
                        <a
                          ...
                          title="Open official visa source (may be blocked by some government sites)"
                        >
                          View Source
                        </a>
                        <button
                      ...
                      {source.notes && (
                        <div className="text-xs text-gray-500 mt-1" title={source.notes}>
                          {source.notes}
                        </div>
                      )}
                    </td>
